...
SettingAnalyticProperties::SettingAnalyticProperties()
{
}
...
void SettingAnalyticProperties::SetInputData(vtkUnstructuredGrid *in_voxelMesh)
{
  this->voxelMeshForAnalysis = vtkSmartPointer<vtkUnstructuredGrid>::New();
  this->voxelMeshForAnalysis->DeepCopy(in_voxelMesh);
}

void SettingAnalyticProperties::Update()
{
  SetProperties();
  this->voxelMeshForAnalysis->GetCellData()->AddArray(analyticProperties);
}

vtkUnstructuredGrid *SettingAnalyticProperties::GetOutput()
{
  return voxelMeshForAnalysis;
}

// 解析場全体の属性を初期化
void SettingAnalyticProperties::SetProperties()
{
...
void SettingAnalyticProperties::SetOnePropertyOfAllRegion(AnalyticProoerty in_prop)
{
...
void SettingAnalyticProperties::SetPropertiesOf3DModel()
{
...
void SettingAnalyticProperties::SetPropertiesOfWalls()
{
  // X方向の両端にある壁
