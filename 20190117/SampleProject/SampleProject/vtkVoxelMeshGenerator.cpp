...
void vtkVoxelMeshGenerator::SetInputData(vtkPolyData *in_polyData)
{
  this->polyData = vtkSmartPointer<vtkPolyData>::New();
  this->polyData->DeepCopy(in_polyData);
}

void vtkVoxelMeshGenerator::Update()
{
  SetParameters();  // 諸元の設定
  GenerateVoxelMesh();
}

void vtkVoxelMeshGenerator::SetParameters()
{
...
void vtkVoxelMeshGenerator::GenerateVoxelMesh()
{
  // 等間隔格子点生成
...
// 内外判定
const bool vtkVoxelMeshGenerator::IsInsideOrOutside(const double *in_points, vtkImplicitPolyDataDistance *in_implicitPolyDataDistance)
{
...
void vtkVoxelMeshGenerator::AddIs3DModelIds(vtkPoints *in_voxelCenters)
{
...
void vtkVoxelMeshGenerator::AddOriginalVoxelId()
{
...
vtkUnstructuredGrid *vtkVoxelMeshGenerator::GetOutput()
{
